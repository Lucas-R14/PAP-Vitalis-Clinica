// editar_funcionario.js

// Função para redirecionar após 2 segundos
function redirecionar() {
    setTimeout(function() {
        window.location.href = 'gerir_funcionarios.php';
...
function inicializarFlatpickr() {
    ...
    // Inicializa o Flatpickr para o campo de data de admissão
    flatpickr("#data_admissao", {
        locale: "pt", // Define o idioma para português
        dateFormat: "Y-m-d", // Formato da data
        defaultDate: document.getElementById("data_admissao").value, // Data padrão
    });
}
